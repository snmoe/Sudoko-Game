...
private void restrictToSingleDigit(JTextField field) {
...
private void addValidationListener(javax.swing.JTextField field, javax.swing.JTextField[] allFields) {
    field.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
        ...
        private void checkCells() {
            ...
            Solve.setEnabled(emptyCount == 5||emptyCount == 4||emptyCount == 3||emptyCount == 2||emptyCount == 1);
            Verify.setEnabled(emptyCount == 0);
        }
    });
}
...
private void loadGrid(int[][] grid) {
    for (int r = 0; r < 9; r++) {
        for (int c = 0; c < 9; c++) {
            JTextField field = cells[r][c];

            if (grid[r][c] != 0) {
                field.setText(String.valueOf(grid[r][c]));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Undo, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20))
        );
